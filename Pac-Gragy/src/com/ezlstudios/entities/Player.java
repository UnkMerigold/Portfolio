package com.ezlstudios.entities;

import java.awt.Graphics;
import java.awt.image.BufferedImage;

import com.elzstudios.main.Game;
import com.ezlstudios.world.Camera;
import com.ezlstudios.world.World;
...
public class Player extends Entity{
	...
	public void tick(){
		...
		if(Game.frutas_contagem == Game.frutas_atual) {
			//Aqui voc� pode colocar sua l�gica de quando ganhou o jogo.
			//por exemplo: Parab�ns! Voc� coletou todas as frutas no mapa.
			World.restartGame();
		}
	}
